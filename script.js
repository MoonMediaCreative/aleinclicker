...
import { getDatabase, ref, set, get, child, query, orderByChild, limitToFirst } from "https://www.gstatic.com/firebasejs/11.0.2/firebase-database.js";
...
function startGame() {
  ...
  isGameActive = true;
  currentImage = 1;
  aleinImage.src = "https://static.wixstatic.com/media/dae1d7_8eb573f205b04f4c9824986412fa186f~mv2.png"; // Reset to first image
